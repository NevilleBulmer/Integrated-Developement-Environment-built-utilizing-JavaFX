...
public class DialogBox implements EventHandler<ActionEvent> 
{
    ...
    public void showOptionBox(String title, String message)
    {
    ...
    public void showRenameBox(String title, String message)
    {
        ...
        InputBox.getChildren().addAll(inputBox);
        InputBox.setAlignment(Pos.CENTER);
        
        HBox AnswerBox = new HBox(20);
        AnswerBox.getChildren().addAll(Yes, No);
        AnswerBox.setAlignment(Pos.CENTER);

        VBox VB = new VBox(15);
        VB.getChildren().addAll(messageToDisplay, InputBox, AnswerBox);
        VB.setAlignment(Pos.CENTER);
        VB.setId("OptionBox");
    ...
    public void showDeleteBox(String title, String message)
    {
        OptionStage = new Stage();
        OptionStage.setTitle(title);
        OptionStage.initModality(Modality.APPLICATION_MODAL);
        ...
        VBox VB = new VBox(15);
        VB.getChildren().addAll(messageToDisplay, AnswerBox);
        VB.setAlignment(Pos.CENTER);
        VB.setId("OptionBox");
    ...
    public void showAlertBox(String title, String message)
    {
        ...
        AlertScene = new Scene(VB, 300, 100);
